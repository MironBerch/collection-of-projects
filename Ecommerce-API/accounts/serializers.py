...
class UserRegistrationSerializer(RegisterSerializer):
    """
    Serializer for registration new users using email address or phone number.
    """
    username = None
    ...
    def validate(self, validated_data):
        ...
        if not (email or phone_number):
            raise serializers.ValidationError(
                _('Enter an email address or a phone number.')
            )
...
class UserLoginSerializer(serializers.Serializer):
    """
    Serializer to login users with email address or phone number.
    """
    phone_number = PhoneNumberField(
        required=False,
        allow_blank=True,
    ...
    def validate(self, validated_data):
        ...
        if email:
            ...
            if not email_address:
                raise serializers.ValidationError(
                    _('Email address is not verified.')
                )
...
class PhoneNumberSerializer(serializers.ModelSerializer):
    ...
    def validate_phone_number(self, value):
        try:
            ...
            if queryset.phone.is_verified is True:
...
class AddressReadOnlySerializer(
    CountryFieldMixin,
...
class UserSerializer(serializers.ModelSerializer):
    ...
    addresses = AddressReadOnlySerializer(
        read_only=True,
        many=True,
    )
...
class ShippingAddressSerializer(
    ...
    """
    Serializer class to serialize address of type shipping for shipping address.
    """
...
class BillingAddressSerializer(
    ...
    """
    Serializer class to serialize address of type billing for billing address.
    """
    user = serializers.HiddenField(
        default=serializers.CurrentUserDefault(),
    )
