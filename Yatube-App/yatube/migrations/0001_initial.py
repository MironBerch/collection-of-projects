# Generated by Django 4.0.7 on 2022-12-14 20:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, help_text='Пожалуйста, выберите вашу группу', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='yatube.group', verbose_name='сообщество')),
            ],
            options={
                'verbose_name': 'Запись',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='yatube.post', verbose_name='запись')),
            ],
            options={
